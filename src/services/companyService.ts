...
export class CompanyService implements ICompanyService {
  ...
  async updateCompany(id: number, data: Partial<{ name?: string | undefined; logo?: string | undefined; address?: string | undefined; currency?: string | undefined; periodType?: PeriodType | undefined }>): Promise<Company> {
    const transformedData: { name?: string; logo?: string | null; address?: string; currency?: string; periodType?: PeriodType } = {};

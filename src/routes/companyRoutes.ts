...
router.post("/create", authenticate, authorize(["SUPERADMIN"]), (req, res) => companyController.createCompany(req, res));
router.get("/:id", authenticate, authorize(["SUPERADMIN"]), (req, res) => companyController.getCompany(req, res));
router.put("/:id", authenticate, authorize(["SUPERADMIN"]), (req, res) => companyController.updateCompany(req, res));
